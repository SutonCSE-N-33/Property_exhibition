...
const AllPromotion = () => {
  const { isLoaded, promotionProperties } = usePromotion();
    ...
    <div>
      <div className=" grid justify-center my-5">
        <div className="flex justify-between">
          <h1 className="text-2xl">Running Featured Property</h1>
          <Link
            to="/dashboard/add-Feature-property"
        ...
        <div className="">
          <table className=" text-sm text-gray-500 ">
            ...
            {!isLoaded ? (
              <tbody>
                {promotionProperties.map((promotion, id) => (
                  <tr
                  ...
                  >
                    ...
                    <td className="px-6 py-4"> {promotion.property} </td>
                    <td className="px-6 py-4"> {promotion.start_date} </td>
                    <td className="px-6 py-4"> {promotion.end_date} </td>
                    {/* <td className="px-6 py-4">

                                                    <Link to={promotion.promotion_id} className="rounded bg-red-500 p-1 text-white hover:bg-red-600 p-1">
                                                        Remove
                                                    </Link>
                                                </td> */}
                  </tr>
