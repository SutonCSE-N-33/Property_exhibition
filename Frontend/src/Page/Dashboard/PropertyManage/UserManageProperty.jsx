...
const UserManageProperty = () => {
  ...
  const userWiseProperty = properties.filter(
  ...
  const makingDecisionNo = () => {
    cancelModal();
    navigate("/dashboard/userManageProperty");
  };
    ...
    <div>
      <div className="relative grid justify-center shadow-md sm:rounded-lg mb-10">
        ...
        <p className="text-center font-semibold">
          Total {userWiseProperty.length} Properties Here
        </p>
        <table className="text-sm text-gray-500 dark:text-gray-400 mx-5">
          ...
          {!isLoaded ? (
            <tbody>
              {userWiseProperty.map((property, index) => (
                <tr
                ...
                >
                  ...
                  <td className="py-2 pr-1 whitespace-nowrap dark:text-white">
                    <img
        ...
        <div className="bg-yellow-300 w-60 p-5 rounded">
          ...
          <div className="flex justify-between mt-10 ml-6">
            <button
              ...
              className="p-1.5 bg-red-600 text-white rounded-lg ml-2 mr-10"
            >
              Yes
            </button>
            <button
              onClick={makingDecisionNo}
              className="p-1.5 ml-6 bg-green-400 text-white rounded-lg ml-2 mr-10"
            >
              No
            </button>
          </div>
...
export default UserManageProperty;
